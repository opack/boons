...
public class SplashScreen extends AbstractScreen {
	...
	public void show() {
		...
		// Récupération de la région de l'image depuis l'atlas
		AtlasRegion splashRegion = getAtlas().findRegion("splash-screen/splash-screen");
		Drawable splashDrawable = new TextureRegionDrawable(splashRegion);

		// Création de l'Actor splash image. Sa taille est définie quand
		// la méthode resize() est appelée.
		splashImage = new Image(splashDrawable, Scaling.stretch);
		splashImage.setFillParent(true);

		// Ceci est nécessaire pour que l'effet de fondu d'ouverture fonctionne
		// correctement ; on se contente de mettre l'image complètement transparente
		// au début.
